...
//       if (!headlines.length && category !== "general") {
//         const fallbackRes = await fetch(
//           `${import.meta.env.VITE_API_URL}/chat-news?category=general`
//         );
//         const fallbackData = await fallbackRes.json();
...
//     } catch (err) {
//       console.error("Fetch error:", err);
//       return ["❌ Failed to fetch news. Try again."];
//     }
//   };
...
//         sender: "bot",
//         text: headlines.length
//           ? `Here are the latest ${fetchCategory} updates:\n${headlines.join(
//               "\n"
//             )}`
//           : "I couldn’t find any news for that topic.",
//       },
...
//           }}
//         >
//           <div className="w-full h-full bg-white border rounded-xl shadow-xl flex flex-col transition-all duration-300 overflow-hidden">
//             {/* Header */}
//             <div className="drag-handle flex justify-between items-center px-3 py-2 bg-blue-600 text-white font-semibold rounded-t-xl cursor-move">
//               <span>📰 NewsBot</span>
//               <button
//                 onClick={() => setIsOpen(false)}
//                 className="p-2 rounded-full bg-red-500 hover:bg-red-600 focus:outline-none transition-all duration-200 pointer-events-auto"
//               >
//                 ✕
//               </button>
//             </div>
...
//                 <div
//                   key={i}
//                   className={`my-1 p-2 rounded-lg text-sm shadow-sm ${
//                     msg.sender === "user"
