...
const Entertainment = () => {
  ...
  useEffect(() => {
    fetchData('entertainment', 1).then((data) => {
      setBreakingNews(data[0]);
    });
    fetchData('entertainment', 5).then(setTopNews);
    fetchData('entertainment', 21).then(setEntertainmentNews);
  }, []);
  ...
  return (
    <section className="entertainment">
      ...
      <div className="page2">
        <div className="news" id="entertainmentNews">
          <div className="title">
            <h2>Daily News</h2>
          </div>
